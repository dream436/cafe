    ...
    <div>
      <div className="lg:flex w-full">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div className="py-1 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
            <div className="cursor-pointer flex items-center">
              <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">
                Deepaashi Table Manager{" "}
              </div>
            </div>
          </div>
            ...
            <div className="mt-12">
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <GoogleOAuthProvider clientId="935653517868-0k10pcb0uv6f56b66lq2aivf3al02ib8.apps.googleusercontent.com">
                    <GoogleLogin
                      size={"large"}
                      shape={"pill"}
                      onSuccess={(credentialResponse) => {
                        const detail = jwt_decode(
